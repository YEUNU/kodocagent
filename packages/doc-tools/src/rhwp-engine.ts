...
// ─────────────────────────────────────────────────────────
// 구조 손실 감지 (propose_find_replace / propose_table_structure 공용)
// ─────────────────────────────────────────────────────────
...
/**
 * rhwp exportHwpx() 전후 블록 히스토그램을 비교하여 구조 손실을 감지한다.
 *
 ...
 * 따라서 카운트가 줄어드는 경우는 rhwp가 콘텐츠를 드롭한 것이다.
 *
 * @param beforeBlocks  원본 kordoc parse().blocks
 * @param afterBlocks   exportHwpx() 후 재파싱한 kordoc parse().blocks
 */
