...
현재 불가(요청받으면 솔직히 알릴 것): 위 도구로 처리할 수 없는 작업 — 글꼴·굵게·줄간격 등 문자/문단 서식과 제목 스타일 일관화, 머리말/꼬리말·쪽번호 레이아웃/서식, 각주 삽입·형식, 목차·개요번호 자동 갱신, 그림·표 번호 상호참조, 이미지·도형·조직도 편집, 중첩(복합)표 안쪽 셀 지정.
